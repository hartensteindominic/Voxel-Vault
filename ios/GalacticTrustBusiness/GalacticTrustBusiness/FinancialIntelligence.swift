...
extension FinancialStore {
    func financialAnswer(_ question: String) -> String {
        ...
        if containsAny(normalized, ["runway", "cash", "balance", "coverage", "how long"]) {
        ...
        if containsAny(normalized, ["profit", "net", "cash flow", "cashflow"]) {
        ...
        if containsAny(normalized, ["largest vendor", "top vendor", "vendor spend"]) {
