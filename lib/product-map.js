export const APP_DOCK = Object.freeze([
  ...
  { id: 'create', href: '/studio', label: 'Create', icon: '+', match: ['/studio', '/capture', '/avatar'] },
...
export const APP_USER_PREFIXES = Object.freeze([
  '/geo', '/vault', '/studio', '/capture', '/avatar', '/marketplace', '/discover', '/ai', '/ai-licensing', '/hunt', '/real-estate', '/forge', '/purchases', '/more',
]);
