...
export const APP_SECTIONS = Object.freeze([
  ...
  { id: 'create', eyebrow: 'CREATE + COLLECT', title: 'Digital assets', description: 'Create and organize digital assets first. Wallets and minting stay optional.', items: [
    { id: 'property', href: '/property', label: 'VoxelPop Property', icon: '+', description: 'Authorized house photo → confirm address → $4.99 → voxel image → movable 3D voxel → save to Vault → optional one-property mint.', badge: 'LIVE' },
