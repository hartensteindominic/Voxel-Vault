...
export const APP_SECTIONS = Object.freeze([
  ...
  {
    id: 'property-money',
    eyebrow: 'OPTIONAL PROPERTY + MONEY TOOLS',
    title: 'Sandbox, providers + verification',
    ...
    items: [
      ...
      { id: 'rentals', href: '/vault/rentals', label: 'Rental records', icon: '⌂', description: 'View verified lease and payment records when evidence exists.', badge: 'LEASE' },
