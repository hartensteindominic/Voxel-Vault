...
export const APP_SECTIONS = Object.freeze([
  ...
  { id: 'create', eyebrow: 'CREATE + COLLECT', title: 'Digital assets', description: 'Create and organize digital assets first. Wallets and minting stay optional.', items: [
    { id: 'property', href: '/property', label: 'VoxelPop Property', icon: '+', description: 'Authorized house photo → $4.99 → 3D voxel photo → approval → movable 3D voxel → save or optional mint.', badge: 'LIVE' },
    { id: 'digital-estates', href: '/vault/estates', label: '$1.99 Digital Properties', icon: '⌂', description: 'Buy low-cost 3D digital property collectibles on one disclosed relative-price index. NFT portability stays optional.', badge: 'DIGITAL MARKET' },
  ...
  { id: 'property-money', eyebrow: 'SANDBOX + VERIFIED PROVIDERS', title: 'Money + real property', description: 'These tools stay separate because a demo, financial position, lease, deed and NFT are not the same thing. Live financial or property rights require verified providers, eligibility and legal rails.', items: [
    { id: 'money-hub', href: '/vault/money', label: 'Money Hub', icon: '$', description: 'See USD-provider, self-custody crypto, and property/NFT layers together without a fake combined balance.', badge: 'SOURCE-SEPARATED' },
  ...
  { id: 'intelligence', eyebrow: 'OPTIONAL EXPERIENCES', title: 'AI + playful tools', description: 'Useful extras stay available without crowding the core VoxelPop creation and Vault flow.', items: [
