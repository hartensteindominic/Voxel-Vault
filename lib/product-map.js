...
export function isSimplePropertyRoute(pathname = '/') {
  ...
  return path === '/' || path === '/property' || path.startsWith('/property/') || path === '/geo/slice' || path.startsWith('/geo/slice/') || path === '/world' || path.startsWith('/world/') || path === '/vault' || path.startsWith('/vault/') || path === '/demo' || path.startsWith('/demo/');
}
