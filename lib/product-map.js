...
export const APP_SECTIONS = Object.freeze([
  ...
  { id: 'property-money', eyebrow: 'OPTIONAL PROPERTY + MONEY TOOLS', title: 'Demo, providers + title', description: 'A demo, provider-backed position, lease, deed and NFT stay legally separate even when they appear in one app.', items: [
    { id: 'property-slice', href: '/geo/slice', label: '$1.99 Property Demo', icon: '¢', description: 'Compare tiny hypothetical property slices with fake demo balances only. No real funds or property rights move.', badge: 'DEMO' },
