...
export const APP_DOCK = Object.freeze([
  ...
  { id: 'vault', href: '/vault', label: 'Vault', icon: '◇', match: ['/vault', '/purchases', '/room', '/trade', '/asset', '/bank'] },
...
export const APP_SECTIONS = Object.freeze([
  ...
  { id: 'property-money', eyebrow: 'SANDBOX + VERIFIED PROVIDERS', title: 'Money + real property', description: 'These tools stay separate because a demo, financial position, lease, deed and NFT are not the same thing. Live financial or property rights require verified providers, eligibility and legal rails.', items: [
    { id: 'galactic-trust', href: '/bank', label: 'Galactic Trust', icon: 'G', description: 'A bank-style financial home for authenticated provider data, digital card controls, security and future regulated money movement.', badge: 'BETA' },
...
export const APP_USER_PREFIXES = Object.freeze(['/property', '/world', '/geo', '/vault', '/bank', '/studio', '/capture', '/receipt', '/avatar', '/room', '/trade', '/asset', '/marketplace', '/discover', '/ai', '/ai-licensing', '/hunt', '/real-estate', '/forge', '/purchases', '/more', '/admin']);
