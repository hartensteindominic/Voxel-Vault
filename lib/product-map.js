...
export const APP_DOCK = Object.freeze([
  ...
  { id: 'vault', href: '/vault/property-drafts', label: 'Vault', icon: '◇', match: ['/vault', '/purchases', '/room', '/trade', '/asset'] },
...
export const APP_SECTIONS = Object.freeze([
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'vault', href: '/vault/property-drafts', label: 'My Collection', icon: '◇', description: 'Keep saved and collected digital property voxels in the simple consumer Vault.', badge: 'LIVE' },
  ...
  },
  {
    ...
    // Safety contract: Browse provider-backed real-estate securities and sandbox/live states.
    items: [
      ...
      { id: 'invest', href: '/real-estate/reits', label: 'Real-Estate Investments', icon: '$', description: 'Browse provider-backed real-estate securities and sandbox/live states. Live investing remains locked until an approved offering and intermediary are active.', badge: 'PROVIDER-GATED' },
  ...
  },
  {
    ...
    items: [
      { id: 'full-vault', href: '/vault', label: 'Full Asset Vault', icon: '▦', description: 'Advanced multi-asset view for creator items, optional wallet holdings and verified provider-bound positions.', badge: 'ADVANCED' },
