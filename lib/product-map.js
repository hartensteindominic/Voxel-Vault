...
export const APP_SECTIONS = Object.freeze([
  ...
  },
  {
    ...
    items: [
      { id: 'property', href: '/property', label: 'VoxelPop Property', icon: '+', description: 'Authorized photo → $4.99 local voxel creation → source-backed 3D map → optional digital collectible.', badge: 'LIVE' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'invest', href: '/real-estate/reits', label: 'Property Investments', icon: '$', description: 'Browse provider-backed real-estate securities and sandbox/live states. Live execution stays provider- and eligibility-gated.', badge: 'PARTNER' },
