...
export const FIRST_REAL_ERIE_PARCEL = Object.freeze({
  slug: 'erie-618-main',
  countySbl: '111.38-3-8',
  cityScheduleRawSbl: '1113800003008000',
  pin: '1402001113800003008000',
  expectedStreetNumber: '618',
  expectedStreetName: 'MAIN',
  referenceLabel: '618 Main Street · Buffalo, NY',
  identifierSource: 'City of Buffalo charter/property schedule',
  identifierSourceUrl: 'https://www.buffalony.gov/DocumentCenter/View/15387',
  identifierSourceObserved: '2025-06-24',
});
...
export function enrichErieCountyEvidence(result) {
  ...
  return {
    ...
    identifierCrossReference: {
      countySbl: FIRST_REAL_ERIE_PARCEL.countySbl,
      cityScheduleRawSbl: FIRST_REAL_ERIE_PARCEL.cityScheduleRawSbl,
      pin: FIRST_REAL_ERIE_PARCEL.pin,
      source: FIRST_REAL_ERIE_PARCEL.identifierSource,
      sourceUrl: FIRST_REAL_ERIE_PARCEL.identifierSourceUrl,
      observedAt: FIRST_REAL_ERIE_PARCEL.identifierSourceObserved,
    },
    sourceLimitations: [
...
export async function fetchFirstRealErieParcel(options = {}) {
  return fetchErieCountyEvidence({ sbl: FIRST_REAL_ERIE_PARCEL.countySbl }, options);
}
