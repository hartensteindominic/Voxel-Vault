...
/// @notice Finite 8x8 digital-land collectible for the Voxel Vault Base Sepolia demo.
/// @dev Fictional digital parcels only: not deeds, real property, rent rights, securities,
///      investment interests, or claims on physical land.
contract VoxelTestLand is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(address initialOwner) ERC721("Voxel Vault Test Land", "VVTL") Ownable(initialOwner) {
        // Hardhat local chain is permitted strictly for automated tests.
