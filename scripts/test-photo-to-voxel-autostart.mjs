...
assert.match(photoPreview, /const depth = 0\.18/, 'the review stage has visible but bounded voxel depth');
...
assert.doesNotMatch(photoPreview, /backingGeometry|referencePlane/, 'the review stage must not fall back to a flat picture backing');
