...
requireMarkers(root, 'simple root homepage', [
  'VOXELPOP · PHOTO → 3D VOXEL PHOTO → VOXEL → NFT',
  'Start VoxelPop · $4.99',
  '3D voxel photo',
  'Movable 3D voxel',
  'NFT optional',
