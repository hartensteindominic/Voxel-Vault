...
console.log('Guided VoxelPop property checks passed: sign in -> photo -> one $4.99 payment -> 3D voxel photo -> explicit approval -> direct source-photo movable 3D voxel -> auto-save to Vault -> Mint Now or Mint Later, with no 2D poster detour, map/World optional, and regulated/property-rights rails distinct.');
