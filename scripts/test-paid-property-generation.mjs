...
assert.match(photoPreview, /const depth = 0\.42/, '3D voxel photo has meaningful edge-aware block depth instead of a flat picture body');
assert.match(photoPreview, /voxels\.setColorAt\(instance, color\)/, 'voxel-photo colors stay tied to the selected photo');
