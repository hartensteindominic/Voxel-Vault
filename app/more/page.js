    ...
    <div className={styles.shell}>
      ...
      <section className={styles.coreCard}>
        <div className={styles.coreCopy}>
          ...
          <p>Use a new property photo or reuse one you already saved, then continue through <b>3D voxel photo → approve → movable voxel → optional mint</b>.</p>
        ...
        <div className={styles.flowVisual} aria-label="Property creation flow">
          <span>PHOTO</span><i>→</i><span>3D VOXEL PHOTO</span><i>→</i><span>APPROVE</span><i>→</i><span>MOVABLE VOXEL</span><i>→</i><span>OPTIONAL MINT</span>
        </div>
      </section>
