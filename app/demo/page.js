  ...
  return <main className={styles.page}>
    ...
    <div className={styles.shell}>
      ...
      <section className={styles.demoCard}>
        ...
        <div className={styles.viewerSide}>
          ...
          <div className={styles.viewerNote}>{stage === 'preview'
            ? 'This first result is intentionally a 3D voxel photo: colored blocks sampled from the visible source image with real depth you can inspect. It is not a fake photogrammetry reconstruction of unseen walls.'
      ...
      <section className={styles.truth}>
        ...
        <span>One photo can represent the visible view of a house. It cannot prove hidden sides, exact dimensions, parcel boundaries, deed/title, rent, occupancy, investment rights, or any physical-property ownership.</span>
      </section>
    </div>
  </main>;
}
