...
export async function POST(request: Request) {
  ...
  try {
    ...
    const metadata = {
      ...
      anchor_price_cents: String(estate.anchorPriceCents),
      relative_index_bps: String(estate.relativeIndexBps),
    ...
    return NextResponse.json({
      ...
      pricingModel: estate.pricingModel,
      anchorPriceCents: estate.anchorPriceCents,
      relativeIndexBps: estate.relativeIndexBps,
