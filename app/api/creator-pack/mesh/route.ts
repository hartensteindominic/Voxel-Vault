...
export async function POST(request:Request){
 ...
 try{
  ...
  // Meshy smart-topology currently rejects image_enhancement. Keep the topology mode,
  // texture/PBR output, and GLB target, but omit that incompatible option entirely.
