...
const paths = [
  ...
  },
  {
    ...
    copy: 'Use fake demo USD to compare tiny proportional slices. No money, security, or property rights move.',
    href: '/geo/slice',
    action: 'Try the demo',
  },
  {
...
const truthLayers = [
  ...
  ['Digital asset', 'A VoxelPop collectible can be bought and held as a digital asset. It does not include physical-property rights.'],
      ...
      <div className={styles.shell}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroIntro}>
            ...
            <p className={styles.lead}>
              Explore real places in 3D, test a $1.99 sandbox, view provider-backed investment paths, and plan direct ownership through the normal legal title system.
            </p>
            ...
            <div className={styles.heroNote}>
              <span>LIVE DIGITAL · map + digital collectibles</span>
          ...
          <div className={styles.heroVisual}>
            ...
            <div className={styles.visualTop}>
              <span className={styles.darkPill}>3D PROPERTY INTERFACE</span>
              <span className={styles.demoPill}>TRUTH-FIRST</span>
            </div>
            <div className={styles.visualBottom}>
              <div className={styles.propertyCaption}>
                <small>One place can have different records</small>
                <strong>Map ≠ collectible ≠ investment ≠ deed</strong>
              </div>
        ...
        <section className={styles.metricGrid} aria-label="Real-estate product status">
          <div className={styles.metricCard}>
            ...
            <div className={styles.metricValue}>Live digital</div>
            <div className={styles.metricSub}>Source-backed property and map context</div>
          </div>
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>$1.99</div>
            <div className={styles.metricValue}>Demo</div>
            <div className={styles.metricSub}>No real money or ownership</div>
          </div>
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>Invest</div>
            <div className={styles.metricValue}>Partner required</div>
            <div className={styles.metricSub}>Provider controls asset availability and eligibility</div>
          </div>
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>Own</div>
            <div className={styles.metricValue}>Title required</div>
            <div className={styles.metricSub}>Normal closing and recorded deed/title</div>
          </div>
        </section>
        ...
        <section className={`${styles.section} ${styles.sectionDark}`}>
          <div className={styles.sectionHeader}>
            <div>
              <p className={styles.eyebrow}>Choose the right path</p>
              <h2>Four paths. Four meanings.</h2>
            </div>
            <p>Voxel Vault can put these experiences in one app without pretending one automatically becomes another.</p>
          </div>
              ...
              <a href={step.href} key={step.title} className={styles.propertyLink}>
                <article className={styles.propertyCard}>
                  <div className={styles.propertyBody}>
                    <span className={styles.propertyTag}>{step.number} · {step.status}</span>
                    <h3>{step.title}</h3>
                    <p>{step.copy}</p>
        ...
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              <p className={styles.eyebrow}>What each record proves</p>
              <h2>Keep the evidence attached to the claim.</h2>
            </div>
            <p>A beautiful 3D view can make the product easier to understand, but it never upgrades weak evidence into ownership or investment authority.</p>
          </div>
        ...
        <section className={styles.section}>
          <div className={styles.gateCard}>
            ...
            <p>Voxel Vault is not itself a bank, broker, exchange, custodian, or deed registry. Customer money movement, crypto exchange/custody, real-estate securities execution, and real-property ownership only become live through the exact approved provider or legal process required for that action.</p>
            <div className={styles.actions}>
              <a className={styles.primaryButton} href="/property">Create a digital property voxel</a>
              <a className={styles.secondaryButton} href="/real-estate/reits">Check investment status</a>
              <a className={styles.secondaryButton} href="/real-estate/acquire">See direct ownership path</a>
            </div>
          </div>
        </section>

        <footer className={styles.footer}>
          <div><strong>Voxel Vault Real Estate</strong><br />3D place data, digital property collectibles, demo tools, provider-backed investments, and title-based ownership paths.</div>
          <div>Digital product software · not an investment recommendation · no claim of bank, broker, exchange, custody, or deed-registry status.</div>
        </footer>
      </div>
    </main>
  );
