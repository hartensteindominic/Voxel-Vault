...
const truthLayers = [
  ...
  ['Digital asset', 'A VoxelPop creation or collectible can be bought and held as a digital asset. It does not include physical-property rights.'],
    ...
    <main className={styles.page} style={{paddingBottom:'94px'}}>
      <div className={styles.shell}>
        ...
        <footer className={styles.footer}>
          <div><strong>Voxel Vault Real Estate</strong><br />3D place data, digital property assets, demo tools, provider-backed investments, and title-based ownership paths.</div>
          <div>Digital product software · not an investment recommendation · no claim of bank, broker, exchange, custody, escrow, or deed-registry status.</div>
        </footer>
      </div>
    </main>
  );
