...
export default function VoxelFlipMintPage(){
 ...
 async function mint(){
  ...
  try{
   ...
   if(recoverMode)throw new Error('Recovery did not find the original event yet. No new mint transaction was sent.')
