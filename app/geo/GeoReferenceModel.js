...
export default function GeoReferenceModel({ reference, authoritativeTwin = null, viewMode = 'orbit', resetKey = 0 }) {
  ...
  return createElement('div', { style: { position: 'absolute', inset: 0 }, 'aria-label': 'Interactive realistic voxel property and neighborhood reference' },
    ...
    (reference?.found || authoritativeTwin?.structure?.buildingGeometry) ? createElement('div', { style: { marginTop: 5, fontSize: 9, color: 'rgba(242, 224, 196, 0.78)' } }, 'Dense voxel masonry, color variation, lighting + shadow = visual rendering only · no facade, window, roof-form or material facts inferred') : null,
