...
export default function PropertyDraftsPage() {
  ...
  const [note, setNote] = useState('Your saved VoxelPop creations. Minting stays optional.');
  ...
  return <main className="page">
    ...
    <p className="truth">Vault stores your digital VoxelPop creations. Saving, sharing, or minting a voxel does not itself transfer deed/title, rent, fractional investment, occupancy, or other rights in the physical property.</p>
    <style jsx>{`
