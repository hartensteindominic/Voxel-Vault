...
export default function PropertyDraftsPage() {
  ...
  return <main className="page">
    ...
    </article>)}</section> : <section className="empty"><div className="cube"><i/><i/><i/></div><b>No properties yet.</b><span>Add one address and your 3D property will show up here.</span><Link href="/property">+ ADD PROPERTY</Link></section>}
    ...
    <style jsx>{`
      :global(body){margin:0;background:#fffaf0;color:#171221;font-family:Inter,ui-rounded,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.page{min-height:100vh;padding:14px clamp(12px,3vw,30px) calc(90px + env(safe-area-inset-bottom));background:radial-gradient(circle at 4% 22%,#efffb6 0,transparent 25%),radial-gradient(circle at 95% 8%,#eee5ff 0,transparent 26%),#fffaf0}header{max-width:920px;height:52px;margin:auto;display:flex;align-items:center;justify-content:space-between}header>a{width:40px;height:40px;border-radius:13px;background:#7138f5;color:#fff;text-decoration:none;display:grid;place-items:center;font-weight:1000;box-shadow:0 6px 0 #4d1bc5}nav{display:flex;gap:7px}nav a{padding:10px 13px;color:#51495a;text-decoration:none;font-size:11px;font-weight:900;border:1px solid #e1dbe7;border-radius:999px;background:#ffffffc9}.hero{max-width:920px;margin:54px auto 24px;text-align:center}.hero small{color:#7041ed;font-size:12px;font-weight:950;letter-spacing:.14em}.hero h1{font-size:clamp(52px,9vw,82px);line-height:.9;letter-spacing:-.06em;margin:14px 0 8px}.hero p{color:#7a7280;font-size:14px;margin:0}.hero button{margin-top:14px;border:1px solid #ddd6e5;border-radius:999px;background:#fff;color:#5d5565;padding:11px 15px;font-size:10px;font-weight:950}.grid{max-width:920px;margin:0 auto;display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px}.grid article{overflow:hidden;border:1px solid #e4dfea;border-radius:26px;background:#ffffffdb;box-shadow:0 16px 45px #6f51a10e}.visual{height:190px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 35%,#c9ff5424,transparent 30%),#21162c}.ground{position:absolute;left:11%;right:11%;bottom:17%;height:32%;border:1px solid #8c79a0;transform:perspective(340px) rotateX(62deg);border-radius:14px}.house{position:absolute;left:30%;right:30%;bottom:30%;height:38%;background:#fff}.house:before{content:'';position:absolute;left:-10%;right:-10%;top:-13%;height:18%;background:#7138f5}.house i{position:absolute;bottom:18%;width:20%;height:34%;background:#c9ff54}.house i:first-child{left:18%}.house i:last-child{right:18%}.land{position:absolute;left:24%;right:24%;bottom:25%;height:28%;border:2px solid #c9ff54;transform:perspective(320px) rotateX(62deg);border-radius:12px;background:#c9ff5412}.visual span{position:absolute;top:13px;left:13px;padding:7px 10px;border-radius:999px;background:#fff;color:#5c3db1;font-size:8px;font-weight:950;letter-spacing:.08em}.body{padding:18px}.body small{color:#7041ed;font-size:8px;font-weight:950;letter-spacing:.1em}.body h2{font-size:23px;letter-spacing:-.04em;margin:6px 0 15px}.actions{display:grid;grid-template-columns:1fr 1fr;gap:7px}.actions a,.actions button{min-height:44px;border:1px solid #ddd6e5;border-radius:14px;background:#fff;color:#5e5666;text-decoration:none;display:grid;place-items:center;font:inherit;font-size:9px;font-weight:950;cursor:pointer}.actions a:first-child{background:#7138f5;color:#fff;border:0}.actions a:last-child{grid-column:1/-1;background:#171221;color:#fff;border:0}.actions .active{background:#c9ff54;color:#171221;border:0}.more{margin-top:9px;display:flex;gap:12px}.more button{border:0;background:none;color:#a098a3;font-size:8px;font-weight:900;padding:4px 0}.empty{max-width:700px;margin:30px auto;padding:42px 24px;border:1px solid #e4dfea;border-radius:30px;background:#ffffffd7;display:grid;justify-items:center;gap:10px;text-align:center;box-shadow:0 18px 50px #6f51a10d}.empty b{font-size:24px}.empty span{color:#7a7280;font-size:14px}.empty a{margin-top:8px;background:#7138f5;color:#fff;text-decoration:none;border-radius:18px;padding:15px 18px;font-size:12px;font-weight:950;box-shadow:0 7px 0 #4d1bc5}.cube{position:relative;width:66px;height:66px;transform:rotate(30deg) skewY(-8deg);background:#c9ff54;border-radius:10px;box-shadow:0 8px 0 #aee43c}.cube i{position:absolute;background:#7138f5}.cube i:nth-child(1){width:15px;height:15px;left:9px;top:11px}.cube i:nth-child(2){width:15px;height:15px;right:9px;top:11px}.cube i:nth-child(3){width:15px;height:15px;left:25px;bottom:9px}.truth{max-width:920px;margin:16px auto;color:#99909d;font-size:9px;line-height:1.5}@media(max-width:620px){.page{padding:10px 10px calc(82px + env(safe-area-inset-bottom))}.hero{margin-top:34px}.hero h1{font-size:55px}.grid{grid-template-columns:1fr}.visual{height:180px}.actions a,.actions button{min-height:46px}}
    `}</style>
  </main>;
}
