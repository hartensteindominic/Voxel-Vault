...
export default function SavedPropertyDraft3DPage() {
  ...
  return <main className="page">
    ...
    <section className="hero"><small>{fidelityLabel(draft.fidelity)}</small><h1>{draft.label || 'Saved property draft'}</h1><p>{status} Use or add a property picture here whenever you want to rebuild the visual in the clear order: picture → 3D picture → 3D voxel. The generated collectible and source-backed map evidence remain separate.</p></section>
