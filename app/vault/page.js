    ...
    <div className="shell">
      ...
      <section className="section">
        ...
        {shownProperties.length ? <div className="propertyGrid">{shownProperties.map((property) => {
          ...
          <div className="emptyPreview"><img src="/voxelpop/demo-house.png" alt="Built-in illustrative VoxelPop sample house"/><span><small>WHAT YOUR VAULT WILL HOLD</small><b>Property source → 3D preview → finished voxel</b></span></div>
