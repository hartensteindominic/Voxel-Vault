...
function propertyCopy(property) {
  if (property.demoOnly) return 'A demo property reference. Add a house photo to try the same 3D voxel photo → movable voxel flow.';
  ...
  if (property?.commerce?.status === 'paid') return 'This purchased digital property is ready to use as the source for a 3D voxel photo and movable voxel.';
  return 'Use this property as the source for a new photo-matched 3D voxel photo and movable voxel.';
}
...
export default function VaultPage() {
  ...
  return <main className="page">
    ...
    <div className="shell">
      ...
      <section className="section">
        ...
        {shownProperties.length ? <div className="propertyGrid">{shownProperties.map((property) => {
          ...
          <div className="emptyPreview"><img src="/voxelpop/demo-house.svg" alt="Built-in illustrative VoxelPop sample house"/><span><small>WHAT YOUR VAULT WILL HOLD</small><b>Property source → 3D voxel photo → finished voxel</b></span></div>
          <h3>Your first voxel will live here.</h3>
          <p>See the real interaction before paying, or start with one property photo. After the 3D voxel photo is approved and the movable voxel is built, you can reopen it here.</p>
          <div className="emptyActions"><Link className="emptyPrimary" href="/demo">See free sample</Link><Link href="/property">Create yours · $4.99</Link></div>
        </div>}
      </section>
    ...
    <style jsx>{`
      :global(body){margin:0;background:#fffaf0;color:#25180f;font-family:Inter,ui-rounded,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.page{min-height:100vh;padding:0 10px 6px;background:radial-gradient(circle at 8% 12%,#efffb36b 0,transparent 24%),radial-gradient(circle at 92% 8%,#eee4ff 0,transparent 27%),#fffaf0}.shell{width:min(1050px,100%);margin:auto}.hero{text-align:center;padding:36px 0 27px}.hero>small,.sectionHead small,.extras small,.purchased small{font-size:8.5px;letter-spacing:.14em;color:#7138f5;font-weight:1000}.hero h1{margin:9px 0 12px;font-size:clamp(48px,8vw,74px);line-height:.9;letter-spacing:-.065em}.hero h1 em{font-style:normal;color:#7138f5}.hero p{max-width:650px;margin:auto;color:#6e646d;font-size:12px;line-height:1.55}.heroActions{margin:17px auto 0;display:flex;justify-content:center;align-items:center;gap:8px;flex-wrap:wrap}.heroActions a,.heroActions button{min-height:48px;padding:0 16px;border-radius:13px;border:1px solid #ded5e3;background:#fff;color:#655b65;font:inherit;font-size:10px;font-weight:1000;text-decoration:none;cursor:pointer}.heroActions .primary{background:#7138f5;color:#fff;border-color:#7138f5;box-shadow:0 8px 20px rgba(113,56,245,.16)}.synced{padding:9px 12px;border-radius:999px;background:#eee8ff;color:#6337ce;font-size:8.5px;font-weight:1000;letter-spacing:.08em}.section{padding:25px 0;border-top:1px solid #e8dfd6}.sectionHead{display:flex;align-items:end;justify-content:space-between;gap:15px;margin-bottom:12px}.sectionHead h2,.extras h2{font-size:clamp(28px,4.5vw,43px);letter-spacing:-.052em;margin:4px 0 0}.sectionHead p{margin:5px 0 0;color:#71676f;font-size:10.5px;line-height:1.45}.sectionHead>a{font-size:9.5px;font-weight:950;color:#694fc0;text-decoration:none}.propertyGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.propertyCard{overflow:hidden;border:1px solid #e1d9e5;border-radius:19px;background:#ffffffd8;box-shadow:0 10px 30px rgba(69,43,94,.05)}.propertyCard.demo{border-style:dashed}.propertyVisual{height:205px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 30%,rgba(201,255,84,.16),transparent 32%),#21172c}.propertyVisual>img{width:100%;height:100%;object-fit:cover}.propertyVisual>span,.creationImage>span{position:absolute;left:12px;top:12px;padding:6px 9px;border-radius:999px;background:#7138f5;color:#fff;font-size:7.5px;font-weight:1000;letter-spacing:.09em}.miniScene{position:absolute;inset:0}.miniScene:before{content:'';position:absolute;left:14%;right:14%;bottom:17%;height:33%;background:#8fce52;transform:perspective(330px) rotateX(62deg);border-radius:16px}.miniScene b{position:absolute;left:35%;right:35%;bottom:31%;height:34%;background:#f0c78f}.miniScene b:before{content:'';position:absolute;left:-12%;right:-12%;top:-18%;height:24%;background:#7552c0;transform:skewY(-8deg)}.miniScene i{position:absolute;z-index:2;bottom:38%;width:8%;height:13%;background:#9edee2}.miniScene i:first-child{left:40%}.miniScene i:nth-child(2){right:40%}.propertyBody{padding:16px}.propertyBody>small{font-size:7.5px;color:#7c5be0;font-weight:1000;letter-spacing:.11em}.propertyBody h3{font-size:23px;letter-spacing:-.042em;margin:6px 0 7px}.propertyBody p{margin:0;color:#6f6670;font-size:10.5px;line-height:1.5}.priceLine{margin-top:10px;padding:9px 10px;border-radius:12px;background:#f2ffe0;display:flex;align-items:center;justify-content:space-between;color:#526a2e}.priceLine b{font-size:14px}.priceLine span{font-size:8.5px;font-weight:900}.cardActions{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:12px}.cardActions a{min-height:43px;border-radius:11px;display:grid;place-items:center;text-align:center;text-decoration:none;font-size:8.5px;font-weight:1000;padding:4px 6px}.make3d{background:#7138f5;color:#fff;box-shadow:0 7px 17px rgba(113,56,245,.14)}.open3d{border:1px solid #ded6e4;background:#fff;color:#665c69}.mint{grid-column:1/-1;background:#21172c;color:#fff}.empty{padding:17px;border:1px solid #ded6e3;border-radius:19px;background:#ffffffc7;box-shadow:0 10px 28px rgba(69,43,94,.045);text-align:center}.emptyPreview{max-width:520px;margin:0 auto 12px;padding:8px;display:grid;grid-template-columns:100px 1fr;align-items:center;gap:12px;border:1px solid #e3dce6;border-radius:15px;background:#fff;text-align:left}.emptyPreview img{width:100px;height:76px;object-fit:cover;border-radius:11px}.emptyPreview span{display:grid;gap:4px}.emptyPreview small{color:#756b7a;font-size:7.5px;font-weight:1000;letter-spacing:.1em}.emptyPreview b{font-size:12px;line-height:1.25}.empty h3{font-size:22px;margin:8px 0 6px}.empty>p{max-width:560px;margin:auto;color:#71676f;font-size:10.5px;line-height:1.55}.emptyActions{max-width:480px;margin:13px auto 0;display:grid;grid-template-columns:1fr 1fr;gap:7px}.emptyActions a{min-height:45px;border:1px solid #ded6e3;border-radius:12px;background:#fff;color:#665c69;text-decoration:none;display:grid;place-items:center;font-size:9.5px;font-weight:1000}.emptyActions .emptyPrimary{background:#7138f5;color:#fff;border-color:#7138f5;box-shadow:0 7px 17px rgba(113,56,245,.14)}.creationsSection{padding-bottom:28px}.creationGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.creationCard{overflow:hidden;border:1px solid #e3dbe7;border-radius:17px;background:#fff}.creationImage{height:150px;position:relative;background:#21172c}.creationImage img{width:100%;height:100%;object-fit:cover}.creationCard>div:last-child{padding:11px}.creationCard h3{margin:0;font-size:15px}.creationCard p{margin:3px 0 0;color:#827883;font-size:8.5px}.smallEmpty{padding:16px;border:1px solid #e5dee7;border-radius:15px;background:#ffffffb8;color:#756b73;font-size:9.5px;display:grid;gap:3px}.smallEmpty b{color:#302633;font-size:11px}.smallEmpty span{line-height:1.45}.purchased{margin:2px 0 24px;border:1px solid #e5dce8;border-radius:19px;background:#ffffffad;overflow:hidden}.purchased summary{list-style:none;cursor:pointer;padding:17px;display:flex;align-items:center;justify-content:space-between;gap:12px}.purchased summary::-webkit-details-marker{display:none}.purchased summary span{display:grid;gap:3px;text-align:left}.purchased summary b{font-size:16px}.purchased summary i{width:31px;height:31px;border-radius:10px;background:#eee8ff;color:#7138f5;display:grid;place-items:center;font-style:normal;font-weight:1000}.purchased[open] summary i{transform:rotate(45deg)}.purchasedIntro{margin:0;padding:0 17px 15px;color:#71676f;font-size:9.5px}.purchased .propertyGrid,.purchased .smallEmpty{margin:0 17px 17px}.extras{padding:22px;border-radius:19px;background:#21172c;color:#fff;display:grid;grid-template-columns:1fr auto;align-items:center;gap:17px}.extras small{color:#c9ff54}.extras h2{margin-top:5px}.extras p{max-width:650px;margin:7px 0 0;color:#c9becf;font-size:9.5px;line-height:1.55}.extras>a{min-width:135px;min-height:46px;border-radius:12px;background:#fff;color:#5d36c5;text-decoration:none;display:grid;place-items:center;font-size:9px;font-weight:1000}@media(max-width:720px){.hero{padding-top:28px}.hero h1{font-size:49px}.propertyGrid,.creationGrid{grid-template-columns:1fr}.sectionHead{align-items:flex-start}.propertyVisual{height:190px}.extras{grid-template-columns:1fr}.extras>a{width:100%}}@media(max-width:480px){.page{padding-left:8px;padding-right:8px}.heroActions{display:grid}.heroActions>*{width:100%;box-sizing:border-box}.cardActions{grid-template-columns:1fr}.mint{grid-column:auto}.purchased .propertyGrid,.purchased .smallEmpty{margin-left:12px;margin-right:12px}.emptyPreview{grid-template-columns:76px 1fr}.emptyPreview img{width:76px;height:61px}.emptyActions{grid-template-columns:1fr}}
    `}</style>
  </main>;
}
