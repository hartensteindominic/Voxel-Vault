...
export default function VaultPage() {
  ...
  return <main className="page"><div className="shell">
    ...
    <section className="section">
      ...
      })}</div> : <div className="empty"><div className="emptyIcon">+</div><h3>Start with one property photo.</h3><p>Pay $4.99 once, see the 3D preview, approve it, and build the voxel. Your finished creation comes back here.</p><Link href="/property">Create my first voxel →</Link></div>}
    </section>
  ...
  <style jsx>{`
    :global(body){margin:0;background:#fffaf0;color:#25180f;font-family:Inter,ui-rounded,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.page{min-height:100vh;padding:10px 10px 6px;background:radial-gradient(circle at 8% 12%,#efffb36b 0,transparent 24%),radial-gradient(circle at 92% 8%,#eee4ff 0,transparent 27%),#fffaf0}.shell{width:min(1050px,100%);margin:auto}.top{min-height:54px;display:flex;justify-content:space-between;align-items:center;gap:12px}.brand{display:flex;align-items:center;gap:8px;text-decoration:none;color:#281b13;font-size:8px;letter-spacing:.13em}.brand span{width:35px;height:35px;border-radius:12px;display:grid;place-items:center;background:#7138f5;color:#fff;font-size:17px;box-shadow:0 4px 0 #4f20c5}.top>div{display:flex;gap:5px}.top>div a{padding:9px 11px;border:1px solid #e1d8e7;border-radius:999px;background:#ffffffbd;color:#615762;text-decoration:none;font-size:8px;font-weight:950}.hero{text-align:center;padding:42px 0 29px}.hero>small,.sectionHead small,.extras small,.purchased small{font-size:7.5px;letter-spacing:.15em;color:#7138f5;font-weight:1000}.hero h1{margin:9px 0 12px;font-size:clamp(48px,8vw,78px);line-height:.9;letter-spacing:-.065em}.hero h1 em{font-style:normal;color:#7138f5}.hero p{max-width:650px;margin:auto;color:#81756d;font-size:11.5px;line-height:1.55}.heroActions{margin:18px auto 0;display:flex;justify-content:center;align-items:center;gap:8px;flex-wrap:wrap}.heroActions a,.heroActions button{min-height:48px;padding:0 16px;border-radius:15px;border:1px solid #ded5e3;background:#fff;color:#655b65;font:inherit;font-size:9px;font-weight:1000;text-decoration:none;cursor:pointer}.heroActions .primary{background:#7138f5;color:#fff;border-color:#7138f5;box-shadow:0 5px 0 #4d1bc5}.synced{padding:9px 12px;border-radius:999px;background:#edffd0;color:#50701d;font-size:7.5px;font-weight:1000;letter-spacing:.08em}.section{padding:25px 0;border-top:1px solid #e8dfd6}.sectionHead{display:flex;align-items:end;justify-content:space-between;gap:15px;margin-bottom:12px}.sectionHead h2,.extras h2{font-size:clamp(28px,4.5vw,43px);letter-spacing:-.052em;margin:4px 0 0}.sectionHead p{margin:5px 0 0;color:#81756d;font-size:9.5px;line-height:1.45}.sectionHead>a{font-size:8.5px;font-weight:950;color:#694fc0;text-decoration:none}.propertyGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.propertyCard{overflow:hidden;border:1px solid #e1d9e5;border-radius:23px;background:#ffffffd8;box-shadow:0 13px 36px rgba(69,43,94,.06)}.propertyCard.demo{border-style:dashed}.propertyVisual{height:205px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 30%,rgba(201,255,84,.16),transparent 32%),#21172c}.propertyVisual>img{width:100%;height:100%;object-fit:cover}.propertyVisual>span,.creationImage>span{position:absolute;left:12px;top:12px;padding:6px 9px;border-radius:999px;background:#c9ff54;color:#314a09;font-size:6.5px;font-weight:1000;letter-spacing:.09em}.miniScene{position:absolute;inset:0}.miniScene:before{content:'';position:absolute;left:14%;right:14%;bottom:17%;height:33%;background:#8fce52;transform:perspective(330px) rotateX(62deg);border-radius:16px}.miniScene b{position:absolute;left:35%;right:35%;bottom:31%;height:34%;background:#f0c78f}.miniScene b:before{content:'';position:absolute;left:-12%;right:-12%;top:-18%;height:24%;background:#7552c0;transform:skewY(-8deg)}.miniScene i{position:absolute;z-index:2;bottom:38%;width:8%;height:13%;background:#9edee2}.miniScene i:first-child{left:40%}.miniScene i:nth-child(2){right:40%}.propertyBody{padding:16px}.propertyBody>small{font-size:6.5px;color:#7c5be0;font-weight:1000;letter-spacing:.11em}.propertyBody h3{font-size:23px;letter-spacing:-.042em;margin:6px 0 7px}.propertyBody p{margin:0;color:#7d727a;font-size:9.5px;line-height:1.5}.priceLine{margin-top:10px;padding:9px 10px;border-radius:12px;background:#f2ffe0;display:flex;align-items:center;justify-content:space-between;color:#526a2e}.priceLine b{font-size:14px}.priceLine span{font-size:7.5px;font-weight:900}.cardActions{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:12px}.cardActions a{min-height:43px;border-radius:12px;display:grid;place-items:center;text-align:center;text-decoration:none;font-size:7.5px;font-weight:1000;padding:4px 6px}.make3d{background:#7138f5;color:#fff;box-shadow:0 4px 0 #4d1bc5}.open3d{border:1px solid #ded6e4;background:#fff;color:#665c69}.mint{grid-column:1/-1;background:#21172c;color:#fff}.empty{padding:28px;border:1px dashed #d9ccdf;border-radius:23px;background:#ffffffa8;text-align:center}.emptyIcon{width:58px;height:58px;border-radius:18px;margin:auto;display:grid;place-items:center;background:#c9ff54;font-size:28px}.empty h3{font-size:22px;margin:12px 0 6px}.empty p{max-width:560px;margin:auto;color:#81756d;font-size:10px;line-height:1.55}.empty a{display:inline-grid;place-items:center;margin-top:13px;padding:12px 16px;border-radius:13px;background:#7138f5;color:#fff;text-decoration:none;font-size:8.5px;font-weight:1000}.creationsSection{padding-bottom:28px}.creationGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.creationCard{overflow:hidden;border:1px solid #e3dbe7;border-radius:18px;background:#fff}.creationImage{height:150px;position:relative;background:#21172c}.creationImage img{width:100%;height:100%;object-fit:cover}.creationCard>div:last-child{padding:11px}.creationCard h3{margin:0;font-size:15px}.creationCard p{margin:3px 0 0;color:#827883;font-size:7.5px}.smallEmpty{padding:18px;border-radius:17px;background:#ffffffb0;color:#756b73;font-size:9px}.purchased{margin:2px 0 24px;border:1px solid #e5dce8;border-radius:22px;background:#ffffffad;overflow:hidden}.purchased summary{list-style:none;cursor:pointer;padding:17px;display:flex;align-items:center;justify-content:space-between;gap:12px}.purchased summary::-webkit-details-marker{display:none}.purchased summary span{display:grid;gap:3px;text-align:left}.purchased summary b{font-size:16px}.purchased summary i{width:31px;height:31px;border-radius:10px;background:#eee8ff;color:#7138f5;display:grid;place-items:center;font-style:normal;font-weight:1000}.purchased[open] summary i{transform:rotate(45deg)}.purchasedIntro{margin:0;padding:0 17px 15px;color:#81756d;font-size:9px}.purchased .propertyGrid,.purchased .smallEmpty{margin:0 17px 17px}.extras{padding:22px;border-radius:23px;background:#21172c;color:#fff;display:grid;grid-template-columns:1fr auto;align-items:center;gap:17px}.extras small{color:#c9ff54}.extras h2{margin-top:5px}.extras p{max-width:650px;margin:7px 0 0;color:#bfb4c9;font-size:9px;line-height:1.55}.extras>a{min-width:135px;min-height:46px;border-radius:13px;background:#c9ff54;color:#294300;text-decoration:none;display:grid;place-items:center;font-size:8px;font-weight:1000}@media(max-width:720px){.hero{padding-top:32px}.hero h1{font-size:51px}.propertyGrid,.creationGrid{grid-template-columns:1fr}.sectionHead{align-items:flex-start}.propertyVisual{height:190px}.extras{grid-template-columns:1fr}.extras>a{width:100%}}@media(max-width:480px){.page{padding-left:8px;padding-right:8px}.top>div a{padding:8px 9px}.top>div a:last-child{display:none}.heroActions{display:grid}.heroActions>*{width:100%;box-sizing:border-box}.cardActions{grid-template-columns:1fr}.mint{grid-column:auto}.purchased .propertyGrid,.purchased .smallEmpty{margin-left:12px;margin-right:12px}}
  `}</style>
  </main>;
}
