    ...
    <div className={styles.shell}>
      ...
      <header className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <p className={styles.lead}>Start with one property photo. After sign-in and your explicit creation checkout ($4.99), VoxelPop keeps that authorized photo on your device while it builds the local voxel image and movable 3D. Then add the address for source-backed map context.</p>
          ...
          <p className={styles.heroFine}>Creation is $4.99. No wallet required to create. No Meshy credits are used. Payment, collection and minting remain explicit actions.</p>
        </div>
      ...
      <section className={styles.creationCard}>
        <div className={styles.step}><span>+</span><div><p>THE EXPERIENCE</p><h2>One photo → $4.99 creation → 3D → map.</h2><span>Pick the picture first. Once the paid creation is verified, the same screen moves from your photo to the VoxelPop image, movable local 3D, address mapping, and finished World preview.</span></div></div>
        ...
        <small>Your source photo stays on-device. The $4.99 creation payment, optional collectible purchase, minting, trading, and money movement are separate explicit actions.</small>
      </section>

      <section className={styles.unifiedCard}>
        <div className={styles.sectionIntro}><p>AFTER CREATION</p><h2>Everything has a clear home.</h2><span>Create is the front door. World and Vault hold the result. Optional tools stay under More.</span></div>
        <div className={styles.assetGrid}>
          <Link href="/property" className={`${styles.assetTile} ${styles.propertyTile}`}><div className={styles.tileIcon}>+</div><small>CREATE · $4.99</small><strong>Make a VoxelPop</strong><span>Paid local digital creation. No Meshy credits.</span><b>Choose photo →</b></Link>
          ...
          <Link href="/more" className={`${styles.assetTile} ${styles.nftTile}`}><div className={styles.tileIcon}>•••</div><small>MORE</small><strong>Optional tools</strong><span>$1.99 demo, wallets, partner-backed investments, AI, rentals, and verification.</span><b>See More →</b></Link>
        </div>
      </section>

      <section className={styles.convertCard}>
        <div className={styles.convertCopy}><p>CLEAR + LEGIT</p><h2>The digital voxel is not the deed.</h2><span>The photo creates a stylized local VoxelPop; source-backed map data supplies mapped building context. Physical-property rights require the normal verified legal path.</span></div>
        <div className={styles.convertFlow} aria-label="VoxelPop guided flow"><FlowIcon icon="▣" label="Photo" note="authorized"/><i>→</i><FlowIcon icon="◆" label="Voxel" note="$4.99 digital"/><i>→</i><FlowIcon icon="◎" label="Map" note="source-backed"/><i>→</i><FlowIcon icon="◇" label="Vault" note="optional"/></div>
