  ...
  return <main className={styles.page}>
    ...
    <div className={styles.shell}>
      <section className={styles.hero}>
        ...
        <p className={styles.heroLine}>Turn one house photo into a one-of-one voxel collectible tied to its confirmed address.</p>

        <div className={styles.centerMachine}>
          <HomeProductPreview/>
          <Link className={styles.primaryAction} href="/property">Make a house voxel</Link>
          <p className={styles.microCopy}>Saved to your Vault · mint when you want</p>
        </div>
        ...
        <div className={styles.simpleSteps} aria-label="VoxelPop house steps">
          ...
          <div><i>4</i><span><b>Keep</b><small>Save it in your Vault inventory.</small></span></div>
          <div><i>5</i><span><b>Mint</b><small>Mint the one-of-one digital voxel.</small></span></div>
        </div>
      </section>

      <section className={styles.truthCard}>
        <div><b>One property. One collectible.</b><span>The confirmed address blocks duplicate purchase and duplicate mint.</span></div>
        <p>Digital collectible only. No deed, title, or physical-property rights are transferred.</p>
      </section>
